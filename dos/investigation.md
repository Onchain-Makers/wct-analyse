...
8. **资金链已端到端打通**：创世金库 → 子金库 cc9792 → MerkleVester（4 年线性）→ 解锁路由 `0x37badde9…`（Admin Timelock 拥有）→ **~83 个真受益人（64 个人 EOA + 15 个人多签）** = 团队/投资人 vesting 终点。另查实：约 **2.2 亿 WCT 进了 BitGo 机构托管**（OpethWalletSimple 多签），NTT 跨链桥合约 `0x85c0129b…` 已定位。
...
| 去向 | 金额 | 合约 |
|---|---|---|
| **BitGo 机构托管**（多签 OpethWalletSimple ×2 + ForwarderV4） | ≈2.2 亿 | `0x3635457359ecba79b00d8f237318dd87f30c7246`、`0x9ce1b7d493cb094c5148d0adcbc24b66b70fd60d`、`0xb8f922f6ac679f386a892647fd0a3f15e0e0c2e5` |
