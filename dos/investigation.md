...
## 仍可深挖（下一步）
- [ ] 给第一跳大额接收方 `0xcc97929655e472c2ad608acd854c03fa15899e31`（累计收 2 亿）、`0xf853f030927762dc0f4afab429e3b04568b61c61`（1 亿）定性。
- [ ] 做市簇是否净流向 CEX（结合 DEX 池子与 CEX 充值流判断真实抛压）。
- [ ] 质押参与度随时间变化、StakingRewardDistributor 发奖节奏。
- [ ] 跨链：经 NTT 桥到以太坊/Base 的量与持仓分布。
- [ ] 解锁曲线：按月统计 MerkleVester `withdraw` 流出量，画解锁释放节奏
- [ ] 流通量拆桶：金库/归属/质押/CEX/散户 占比饼图
